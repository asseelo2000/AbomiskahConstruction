...
export default function MasonryGallery({ currentLanguage = 'en' }) {
  const [hovered, setHovered] = useState(null);

  // Hardcode the images array here (static, self-contained; replace with your real URLs)
  const images = [
  ...
  // Optional: Add dir for RTL if Arabic
  ...
  return (
    <div className="px-4 py-20 md:px-6" dir={dir}>
      {/* Section Title */}
      <motion.h2
        ...
        viewport={{ once: true }}
      >
        {sectionTitles[currentLanguage]}
      </motion.h2>

      {/* Gallery */}
      <div className="columns-1 gap-4 space-y-4 transition-all sm:columns-2 md:columns-3 lg:columns-4 max-h-[80vh] overflow-y-auto">
